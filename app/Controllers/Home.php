...
class Home extends BaseController
{
    ...
    // Return poles by ownership for bar chart
    public function polesByOwnership()
    {
        $data = $this->InfraElementModel->getElementsGroupedBy('utel_owned', 0, ['elmType'=>'Pole']);
        return $this->response->setJSON($data);
    }
    ...
    public function summaryStats()
    {
        $data = [
            ...
            'polesByOwnership' => (clone $this->InfraElementModel)->getElementsGroupedBy('utel_owned',0,['elmType'=>'Pole']),
            ...
            'ownershipByRegion' => (clone $this->regionModel)->getInfraOwnershipCount('Pole'),
        ];
